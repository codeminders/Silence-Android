...
public class SendTextButton extends androidx.appcompat.widget.AppCompatButton
        ...
        View.OnLongClickListener
{
    ...
    public SendTextButton(Context context) {
        super(context);
    ...
    @SuppressWarnings("unused")
    public SendTextButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.transportOptions = initializeTransportOptions(false);
        ViewUtil.mirrorIfRtl(this, getContext());
    }
    ...
    @SuppressWarnings("unused")
    public SendTextButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onChange(TransportOption newTransport, boolean isManualSelection) {
       ...
       // setText(newTransport.getDescription());
    }
